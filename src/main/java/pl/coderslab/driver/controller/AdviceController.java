...
public class AdviceController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public List<AdviceDto> getAllAdvicesByTag(Principal principal, @PathVariable long tagId) {
    Tag tag =  tagService.findById(tagId).orElseThrow(EntityNotFoundException::new);
